    ...
    <li className='country-card card'>
        <div className="container-card bg-white-box">
            ...
            <div className="countryInfo">
                <p className='card-title'>{name.common.length>20?name.common.slice(0,15)+"...":name.common}</p>
                ...
                <NavLink to={`/country/${name.common}`}><button>Read More</button></NavLink></div></div></li>
  )
}
